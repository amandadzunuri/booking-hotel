...
<head>
    ...
    <style>
        ...
        .background-section {
            ...
            color: white; /* Warna teks yang kontras dengan background */
            padding: 40px;
        }
...
<body>
    ...
    <nav class="navbar px-5 navbar-expand-lg navbar-dark custom-navbar">
        ...
        <a class="navbar-brand" href="index.php"><img src="src/images/logo.png" alt=""></a>
        ...
        <div class="row">
          ...
          <div class="col-md-6 aboutus-text">
            ...
            <p class="mx-4 py-3" style="text-align: justify">
             Kami berkomitmen untuk memberikan pengalaman menginap yang tak terlupakan dengan menyediakan layanan berkualitas tinggi dan kenyamanan maksimal.
             Hotel kami memiliki berbagai tipe kamar yang dapat disesuaikan dengan kebutuhan Anda, mulai dari kamar standar hingga suite eksekutif. 
             Dengan lokasi yang strategis, Anda dapat dengan mudah mengakses berbagai destinasi wisata dan pusat perbelanjaan terkemuka di Jakarta.
            </p>
            <div class="card-body">
